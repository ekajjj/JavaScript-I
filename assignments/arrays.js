...
let car33 = inventory[32].car_year.toString() + " " + inventory[32].car_make.toString() + " " + inventory[32].car_model.toString();
console.log(32);
...
console.log("The last car in the inventory is " + lastCar);
...
let jsonOutput = JSON.stringify(BMWAndAudi);
